...
import 'package:rsue_app/src/config/oss_licenses.dart';
...
class OssLicensesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: CustomAppBar.withBack(titleText: "Лицензии", context: context),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar.withBack(
          titleText: '${package.name} ${package.version}', context: context),
